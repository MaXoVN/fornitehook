...
import me.fortnitehook.features.gui.font.CustomFont;
import me.fortnitehook.features.modules.client.FontMod;
...
public class TextManager
    ...
    public void drawString(String text, float x, float y, int color, boolean shadow) {
        if (ModuleManager.isModuleEnabled(FontMod.getInstance().getName())) {
            if (shadow) {

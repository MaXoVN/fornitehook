...
import me.fortnitehook.features.modules.render.CrystalChams;
import me.fortnitehook.features.modules.render.LegacyGlow;
        ...
        if (mod.isOn()) {
            ...
            if (mod.model.getValue() == CrystalChams.Model.VANILLA) {
                ...
                if (mod.modelColor.getValue()) {
                    final Color rainbow = OyVey.colorManager.getRainbow();

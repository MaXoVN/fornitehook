...
public class UpdateWalkingPlayerEvent
    ...
    public static UpdateWalkingPlayerEvent INSTANCE;
    protected float yaw;
    ...
    public UpdateWalkingPlayerEvent(final int stage, final double posX, final double posY, final double posZ, final float y, final float p, final boolean pOnGround) {
        super(stage);
    ...
    public UpdateWalkingPlayerEvent(final int stage, final UpdateWalkingPlayerEvent event) {

...
import me.fortnitehook.features.modules.combat.AutoCrystalOld;
...
import static me.fortnitehook.util.BlockUtil.getSphere;
import static me.fortnitehook.util.DamageUtil.getBlastReduction;
import static me.fortnitehook.util.DamageUtil.getDamageMultiplied;
import static me.fortnitehook.util.EntityUtil.getPlayerPos;
...
public class CrystalUtil {
    ...
    public static boolean rayTracePlace(BlockPos blockPos) {
        if (AutoCrystalOld.getInstance().directionMode.getValue() != AutoCrystalOld.DirectionMode.VANILLA) {
            double d = 0.45;
            double d2 = 0.05;
            double d3 = 0.95;
            ...
            for (double d4 = d2; d4 <= d3; d4 += d) {
                for (double d5 = d2; d5 <= d3; d5 += d) {
                    for (double d6 = d2; d6 <= d3; d6 += d) {
                        ...
                        if (AutoCrystalOld.getInstance().strictDirection.getValue().booleanValue() && d7 > (double) AutoCrystalOld.getInstance().placeRange.getValue().floatValue()) continue;

...
public class    HoleUtilSafety
    ...
    public static List<Hole> getHoles(double d, BlockPos blockPos, boolean bl) {
        ...
        for (BlockPos blockPos2 : list) {
            ...
            if (!bl || (hole = HoleUtilSafety.isDoubleHole(blockPos2)) == null || mc.world.getBlockState(hole.pos1.add(0, 1, 0)).getBlock() != Blocks.AIR && mc.world.getBlockState(hole.pos2.add(0, 1, 0)).getBlock() != Blocks.AIR) continue;
            arrayList.add(hole);
        }
        return arrayList;
    }
    ...
    public static boolean[] is1x1(BlockPos blockPos, boolean[] arrbl) {
        for (EnumFacing enumFacing : EnumFacing.values()) {
            ...
            if (enumFacing == EnumFacing.UP || (iBlockState = mc.world.getBlockState(blockPos2 = blockPos.offset(enumFacing))).getBlock() == Blocks.BEDROCK) continue;

...
public class RenderUtil
    ...
    public static void drawBlockCrossedESP(final BlockPos pos, final Color color, final float linewidth, final boolean air) {
        ...
        if ((air || iblockstate.getMaterial() != Material.AIR) && mc.world.getWorldBorder().contains(pos)) {
            ...
            final Vec3d interp = EntityUtil.interpolateEntity(mc.renderViewEntity, mc.getRenderPartialTicks());
            drawBlockCrossed(iblockstate.getSelectedBoundingBox(mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), color, linewidth);
        }
    }
    ...
    public static void drawBBFill(AxisAlignedBB axisAlignedBB, Color color) {
        ...
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(axisAlignedBB2.minX + mc.getRenderManager().viewerPosX, axisAlignedBB2.minY + mc.getRenderManager().viewerPosY, axisAlignedBB2.minZ + mc.getRenderManager().viewerPosZ, axisAlignedBB2.maxX + mc.getRenderManager().viewerPosX, axisAlignedBB2.maxY + mc.getRenderManager().viewerPosY, axisAlignedBB2.maxZ + mc.getRenderManager().viewerPosZ))) {
            ...
            GL11.glEnable(2848);
            GL11.glHint(3154, 4354);
            RenderGlobal.renderFilledBox(axisAlignedBB2, (float)color.getRed() / 255.0f, (float)color.getGreen() / 255.0f, (float)color.getBlue() / 255.0f, (float)color.getAlpha() / 255.0f);
            glDisable(2848);
            GlStateManager.depthMask(true);
            GlStateManager.enableDepth();
            GlStateManager.enableTexture2D();

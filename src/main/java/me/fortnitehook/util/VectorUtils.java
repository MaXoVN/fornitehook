...
public class VectorUtils
{
    ...
    public static Plane toScreen(final double x, final double y, final double z) {
        ...
        final Vec3d eyePos = ActiveRenderInfo.projectViewFromEntity(view, VectorUtils.mc.getRenderPartialTicks());
        ...
        boolean bVisible = !(pos.x < 0.0f) && !(pos.y < 0.0f) && !(pos.x > res.getScaledWidth()) && !(pos.y > res.getScaledHeight());

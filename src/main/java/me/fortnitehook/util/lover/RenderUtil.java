...
public class RenderUtil implements Util
{
    ...
    public static void drawText(final AxisAlignedBB pos, final String text) {
        ...
        GlStateManager.pushMatrix();
        glBillboardDistanceScaled((float)pos.minX + 0.5f, (float)pos.minY + 0.5f, (float)pos.minZ + 0.5f, RenderUtil.mc.player, 1.0f);
        GlStateManager.disableDepth();
    ...
    public static void drawOutlinedBlockESP(final BlockPos pos, final Color color, final float linewidth) {
        ...
        ColorUtil ColorUtil;
        drawBoundingBox(iblockstate.getSelectedBoundingBox(RenderUtil.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), linewidth, me.fortnitehook.util.ColorUtil.toRGBA(color));
    }

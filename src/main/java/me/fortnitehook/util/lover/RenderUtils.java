...
import me.fortnitehook.util.lover.gl.GLTexture;
import me.fortnitehook.util.lover.gl.PNGDecoder;
...
public class RenderUtils
{
    ...
    public static Void drawTexture(final ResourceLocation location, final int x, final int y, final int textureX, final int textureY, final int width, final int height) {
        ...
        bufferbuilder.pos(x, y + height, 0.0).tex((textureX) * 0.00390625f, (textureY + height) * 0.00390625f).endVertex();
        bufferbuilder.pos(x + width, y + height, 0.0).tex((textureX + width) * 0.00390625f, (textureY + height) * 0.00390625f).endVertex();
        bufferbuilder.pos(x + width, y, 0.0).tex((textureX + width) * 0.00390625f, (textureY) * 0.00390625f).endVertex();
        bufferbuilder.pos(x, y, 0.0).tex((textureX) * 0.00390625f, (textureY) * 0.00390625f).endVertex();
        tessellator.draw();
        return null;
    }

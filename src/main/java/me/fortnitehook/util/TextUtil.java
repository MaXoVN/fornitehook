...
public class TextUtil {
    ...
    public static String convertColorName(Color color) {
        ...
        switch (color) {
            case AQUA: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.AQUA);
                break;
            }
            case WHITE: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.WHITE);
                break;
            }
            case BLACK: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.BLACK);
                break;
            }
            case DARK_BLUE: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.DARK_BLUE);
                break;
            }
            case DARK_GREEN: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.DARK_GREEN);
                break;
            }
            case DARK_AQUA: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.DARK_AQUA);
                break;
            }
            case DARK_RED: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.DARK_RED);
                break;
            }
            case DARK_PURPLE: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.DARK_PURPLE);
                break;
            }
            case GOLD: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.GOLD);
                break;
            }
            case DARK_GRAY: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.DARK_GRAY);
                break;
            }
            case GRAY: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.GRAY);
                break;
            }
            case BLUE: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.BLUE);
                break;
            }
            case RED: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.RED);
                break;
            }
            case GREEN: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.GREEN);
                break;
            }
            case LIGHT_PURPLE: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.LIGHT_PURPLE);
                break;
            }
            case YELLOW: {
                string = ChatFormatting.RESET + String.valueOf(ChatFormatting.YELLOW) ;
            }
        }
        return string;
    }

...
import me.fortnitehook.util.lover.MathUtil;
import me.fortnitehook.util.lover.RenderUtil;
import me.fortnitehook.util.lover.RenderUtils3D;
...
public class SomeRenders extends Module
{
    ...
    public SomeRenders() {
        super("Renderers", "Renders", Category.RENDER, true, false, false);

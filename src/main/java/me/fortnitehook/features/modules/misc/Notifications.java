...
public class Notifications extends Module {
    ...
    public Notifications() {
        super("Notifications",   "notifs brah",  Category.MISC, true, false, false);
        INSTANCE = this;
    }
    ...
    Setting<Boolean> visualrange = register(new Setting("VisualRange", true, v -> page.getValue() == Page.Pop));

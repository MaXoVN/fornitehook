package me.fortnitehook.features.modules;
...
import me.fortnitehook.features.modules.client.HUD;
...
public class Module
    ...
    public void enable() {
        ...
        if (HUD.INSTANCE().notifyToggles.getValue()) {
            TextComponentString text = new TextComponentString(OyVey.commandManager.getClientMessage() + " " + this.getDisplayName() + ChatFormatting.GREEN + " enabled");
    ...
    public void disable() {
        ...
        if (HUD.INSTANCE().notifyToggles.getValue().booleanValue()) {
            TextComponentString text = new TextComponentString(OyVey.commandManager.getClientMessage() + " " + this.getDisplayName() + ChatFormatting.RED + " disabled");
            Module.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(text, 1);
        }
        this.onToggle();
        this.onDisable();

...
public class Speedmine extends Module {
    ...
    private final Setting<InventoryManager.Switch> mineSwitch = this.register(new Setting<InventoryManager.Switch>("SwitchMode", InventoryManager.Switch.PACKET));
    ...
    public Speedmine() {
        super("Speedmine", "Mines faster.", Category.PLAYER, true, false, false);
        INSTANCE = this;
    }
        ...
        if (!Speedmine.mc.player.capabilities.isCreativeMode) {
            ...
            if (this.minePosition != null && !Speedmine.mc.world.isAirBlock(this.minePosition)) {
                if (mineDamage >= 1.0f/* && !AutoCrystal.getInstance().rotating.getValue()*/) {
                    ...
                    int n2 = OyVey.inventoryManager.searchSlot(this.getEfficientItem(Speedmine.mc.world.getBlockState(this.minePosition)).getItem(), InventoryManager.InventoryRegion.HOTBAR) + 36;
                    if (this.strict.getValue().booleanValue()) {
                        ...
                        OyVey.inventoryManager.switchToItem(this.getEfficientItem(Speedmine.mc.world.getBlockState(this.minePosition)).getItem(), this.mineSwitch.getValue());
                    }
                    ...
                    if (n != -1) {
                        if (this.strict.getValue().booleanValue()) {
                            ...
                            OyVey.inventoryManager.switchToSlot(n, InventoryManager.Switch.PACKET);
                        }
                    }
                    mineDamage = 0.0f;
                    ++this.mineBreaks;

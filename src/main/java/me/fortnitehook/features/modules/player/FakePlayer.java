...
import me.fortnitehook.event.events.TotemPopEvent;
...
import me.fortnitehook.util.femhack.PositionforFPUtil;
...
public class FakePlayer extends Module {
    ...
    public Setting<String> nameFakePlayer = this.register(new Setting<String>("Name FakePlayer", "DarklyOresence"));
    ...
    private final Setting<Boolean> onShift = this.register(new Setting<Boolean>("On Crouch", false));
    ...
    private final Setting<Boolean> gapple = this.register(new Setting<Boolean>("Gapple", false));
    private final Setting<Integer> gappleDelay = this.register(new Setting<Integer>("Gapple Delay", 500, 250, 1000));

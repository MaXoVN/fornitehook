...
import me.fortnitehook.features.modules.exploit.Phase;
...
public class HUD
    ...
    final Setting<Boolean> pulse = this.register(new Setting<>("Pulse", Boolean.TRUE, this::new26));
    ...
    public final Setting<Integer> arraylisty = this.register(new Setting<>("OffsetY", 2, 0, 200, this::new31));
    ...
    public final Setting<Boolean> potions = this.register(new Setting<>("Potions", Boolean.FALSE, this::potions));
    ...
    public void onRender2D(final Render2DEvent render2DEvent) {
        ...
        if (this.friendlist.getValue()) {
            ...
            final int intValue2 = this.y.getValue();
                final int rgba = ColorUtil.toRGBA(ClickGui.INSTANCE().Color.getValue().getRed(), ClickGui.INSTANCE().Color.getValue().getGreen(), ClickGui.INSTANCE().Color.getValue().getBlue(), 255);
            OyVey.textManager.drawString("Yo Homies:", (float)intValue, (float)intValue2, rgba, true);
            ...
            for (final EntityPlayer entityPlayer : HUD.mc.world.playerEntities) {
                if (OyVey.friendManager.isFriend(entityPlayer)) {
                    OyVey.textManager.drawString(entityPlayer.getName(), (float)intValue, (float)n, rgba, true);
        ...
        if ((Phase.collideBlockIntersects(HUD.mc.player.getEntityBoundingBox(), HUD::onRender2D54) || Phase.collideBlockIntersects(HUD.mc.player.getEntityBoundingBox(), HUD::onRender2D55)) && this.burrow.getValue()) {
            OyVey.textManager.drawString(ChatFormatting.DARK_RED + "You are in Burrow!", (float)(this.renderer.scaledWidth / 2.0) - (float)(this.renderer.getStringWidth("You are in Burrow!") / 2.0), (float)(this.renderer.scaledHeight / 2.0) - 20.0f, 200, true);
        }
        ...
        if (this.waterMark.getValue()) {
            final String string = OyVey.MODNAME + " " + ChatFormatting.WHITE + OyVey.MODVER + OyVey.MODBUILD;
        ...
        if (this.arrayList.getValue()) {
            if (this.renderingUp.getValue()) {
                if (this.renderingMode.getValue() == RenderingMode.ABC) {
                    ...
                    for (int l = 0; l < OyVey.moduleManager.sortedModules.size(); ++l) {
                        final Module module = OyVey.moduleManager.sortedModules.get(l);
                ...
                for (int n23 = 0; n23 < OyVey.moduleManager.sortedModulesABC.size(); ++n23) {
                    final String s3 = OyVey.moduleManager.sortedModulesABC.get(n23);
                    n20 += 12;
                    if (this.glow.getValue()) {
                ...
                for (int n25 = 0; n25 < OyVey.moduleManager.sortedModules.size(); ++n25) {
                    final Module module2 = OyVey.moduleManager.sortedModules.get(n25);
        ...
        if (this.renderingUp.getValue()) {
            if (this.potions.getValue()) {
                ...
                for (PotionEffect potionEffect : effects) {
                    final String string5 = s4 + OyVey.potionManager.getColoredPotionString(potionEffect);
                    n27 += 10;
            ...
            if (this.speed.getValue()) {
                final String string6 = s4 + "Speed " + ChatFormatting.WHITE + OyVey.speedManager.getSpeedKpH() + " km/h";
                n27 += 10;
            ...
            if (this.tps.getValue()) {
                final String string7 = s4 + "TPS " + ChatFormatting.WHITE + OyVey.serverManager.getTPS();
                n27 += 10;
            ...
            final String string9 = s4 + "Ping " + ChatFormatting.WHITE + OyVey.serverManager.getPing();
            ...
            if (this.potions.getValue()) {
                ...
                for (PotionEffect potionEffect : effects) {
                    final String string10 = s4 + OyVey.potionManager.getColoredPotionString(potionEffect);
            ...
            if (this.speed.getValue()) {
                final String string11 = s4 + "Speed " + ChatFormatting.WHITE + OyVey.speedManager.getSpeedKpH() + " km/h";
            ...
            if (this.tps.getValue()) {
                final String string12 = s4 + "TPS " + ChatFormatting.WHITE + OyVey.serverManager.getTPS();
            ...
            final String string14 = s4 + "Ping " + ChatFormatting.WHITE + OyVey.serverManager.getPing();
        ...
        final String s5 = this.coords.getValue() ? OyVey.rotationManager.getDirection4D(false) : "";
    ...
    public void renderLag() {
        ...
        if (OyVey.serverManager.isServerNotResponding()) {
            String string = ChatFormatting.RED + "Server not responding " + MathUtil.round((float)OyVey.serverManager.serverRespondingTime() / 1000.0f, 1) + "s.";
    ...
    private boolean potions(Boolean bl) {
        return this.page.getValue() == Page.ELEMENTS;
    }

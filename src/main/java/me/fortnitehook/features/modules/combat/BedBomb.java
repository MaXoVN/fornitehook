...
public class BedBomb
    ...
    private void breakBeds() {
        if (this.explode.getValue().booleanValue() && this.breakTimer.passedMs(this.breakDelay.getValue().intValue()) && this.maxPos != null) {
            ...
            BlockUtil.rightClickBlockLegit(this.maxPos, this.range.getValue().floatValue(), this.rotate.getValue() && !this.place.getValue(), EnumHand.MAIN_HAND, this.yaw, this.pitch, this.shouldRotate, true);

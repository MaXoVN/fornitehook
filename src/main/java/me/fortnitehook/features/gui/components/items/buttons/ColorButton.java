...
public class ColorButton extends Button {
    ...
    public void drawScreen(int n, int n2, float f) {
        if (ClickGui.getInstance().outline.getValue().booleanValue()) {
            int sideColor = ColorUtil.toRGBA(ClickGui.getInstance().Color.getValue().getRed(), ClickGui.getInstance().Color.getValue().getGreen(), ClickGui.getInstance().Color.getValue().getBlue(), ClickGui.getInstance().Color.getValue().getAlpha());
        ...
        RenderUtil.drawRect(x, y, x + (float) width + 7.4f, y + (float) height - 0.5f, !isHovering(n, n2) ? 0x11555555 : -2007673515);
        RenderUtil.drawOutlineRect(x + width - 5, y + 2, x + width + 7, y + height - 2, 0);
        OyVey.textManager.drawStringWithShadow(getName(), x + 2.3f, y - 1.7f - (float) OyVeyGui.getClickGui().getTextOffset(), -1);
        if (setting.isOpen) {
            drawPicker(setting, (int) x + 4, (int) y + 15, (int) x + 4, (int) y + 103, (int) x + 4, (int) y + 95, n, n2);
            OyVey.textManager.drawStringWithShadow(isInsideCopy(n, n2) ? ChatFormatting.UNDERLINE + "Copy" : "Copy", x + 10f, y + 113, -1);
            OyVey.textManager.drawStringWithShadow(isInsidePaste(n, n2) ? ChatFormatting.UNDERLINE + "Paste" : "Paste", x + 60f, y + 113, -1);
    ...
    public boolean isInsideCopy(int mouseX, int mouseY) {
        return mouseOver((int) x + 25, (int) y + 113, (int) (x + 25) + OyVey.textManager.getStringWidth("Copy"), (int) (y + 112) + OyVey.textManager.getFontHeight(), mouseX, mouseY);
    }

    public boolean isInsidePaste(int mouseX, int mouseY) {
        return mouseOver((int) x + 60, (int) y + 113, (int) (x + 60) + OyVey.textManager.getStringWidth("Paste"), (int) (y + 112) + OyVey.textManager.getFontHeight(), mouseX, mouseY);
    }
